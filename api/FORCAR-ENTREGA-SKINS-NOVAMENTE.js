/**
 * Script para FORÇAR entrega das skins novamente (marcar como não entregues)
 */
...
async function forcarEntrega() {
  ...
  try {
    ...
    console.log('========================================');
    console.log('FORÇAR ENTREGA DAS SKINS NOVAMENTE');
    console.log('========================================\n');
    ...
    const [rows] = await pool.query(
      `SELECT id, product_id, license, delivered_at
    ...
    console.log('\n3. As skins devem cair em até 1 segundo!');
    console.log('4. Verifique o inventário (F2) - deve aparecer ItemBox');
    console.log('5. Se não aparecer, verifique os logs do servidor\n');
